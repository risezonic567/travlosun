...
export default function DestinationDetail() {
  ...
  const country = destinations.find(
    (c) => normalizeSlug(c.slug) === normalizeSlug(countrySlug)
  );

  const state = country?.state.find(
    (s) => normalizeSlug(s.slug) === normalizeSlug(stateSlug)
  );
  ...
  // Use first package if multiple exist
