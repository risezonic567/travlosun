            ...
            <section className='relative py-16 p-3'>
                ...
                <div className="relative max-w-5xl mx-auto text-center space-y-6 sm:space-y-8 my-12">
                    ...
                    <p className="text-sm sm:text-base md:text-lg text-gray-600 mx-auto">
                        Welcome to Travel O Sun, India’s trustworthy domestic travel agency, committed to providing
                        breathtaking journeys. Whether you want a relaxing family holiday, a romantic honeymoon, or an
                        unplanned trip, our holiday packages in India can be designed for every dream and budget for an
                        unforgettable journey. We are experts in domestic flights, tour packages, and hotel bookings so
                        that your trip runs smoothly from beginning to end.
                    </p>
                </div>
